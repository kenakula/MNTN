...
/* harmony import */ var _modules_toggler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/toggler */ "./js/modules/toggler.js");
/* harmony import */ var _modules_parallax__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/parallax */ "./js/modules/parallax.js");
/* harmony import */ var _modules_page_scroll__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/page-scroll */ "./js/modules/page-scroll.js");
...
if (_modules_toggler__WEBPACK_IMPORTED_MODULE_3__["menuToggler"]) {
  _modules_toggler__WEBPACK_IMPORTED_MODULE_3__["menuToggler"].addEventListener('click', _modules_toggler__WEBPACK_IMPORTED_MODULE_3__["onMenuTogglerToggleClass"]);
}

Object(_modules_parallax__WEBPACK_IMPORTED_MODULE_4__["parallax"])();
Object(_modules_page_scroll__WEBPACK_IMPORTED_MODULE_5__["pageScroll"])();
...
var pageScroll = function pageScroll() {
  var scrollBtns = document.querySelectorAll('.js-scroll-btn');
  var paginationContainer = document.querySelector('.js-pagination-pages');
  var observerTargets = document.querySelectorAll('[data-target]'); // const paginationTrack = document.querySelector('.js-track');

  var paginationThumb = document.querySelector('.js-thumb');
  var observerOptions = {
    root: null,
    rootMargin: '0px',
    threshold: 0.8
  ...
  var switchBtnClass = function switchBtnClass(btn) {
    var activeBtn = paginationContainer.querySelector('.active');
    activeBtn.classList.remove('active');
    btn.classList.add('active');
  };

  var movePaginationThumb = function movePaginationThumb(btn) {
    var btnIndex = +btn.dataset.index;
    var thumbHeight = getComputedStyle(paginationThumb).height;
    var thumbOffset = btnIndex * parseInt(thumbHeight, 10);
    paginationThumb.style.transform = "translateY(".concat(thumbOffset, "px)");
  };
  ...
  var observerCallback = function observerCallback(entries, observer) {
    entries.forEach(function (entry) {
      if (entry.isIntersecting) {
        ...
        var elementId = element.dataset.target;
        var button = paginationContainer.querySelector("[data-page=\"".concat(elementId, "\"]"));
  ...
  var scrollToTarget = function scrollToTarget(evt) {
    var btn = evt.target.closest('.js-scroll-btn');
    var targetId = btn.dataset.page;
    var targetEl = document.querySelector("[data-target=\"".concat(targetId, "\"]"));
    var blockPosition = window.matchMedia('(max-width: 768px)').matches ? 'start' : 'center';
...
var parallax = function parallax() {
  ...
  var clouds = document.querySelector('.js-clouds');
  var mnts = document.querySelector('.js-mnts');
  var hill = document.querySelector('.js-hill');

  var translate = function translate(y, d, el) {
    el.style.transform = "translateY(".concat(y * d, "px)");
  };

  var onDocumentScroll = function onDocumentScroll(evt) {
...
/*!*******************************!*\
  !*** ./js/modules/toggler.js ***!
  \*******************************/
/*! exports provided: menuToggler, onMenuTogglerToggleClass */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "menuToggler", function() { return menuToggler; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onMenuTogglerToggleClass", function() { return onMenuTogglerToggleClass; });
var menuToggler = document.querySelector('#toggler');
var header = document.querySelector('header.header');

var onMenuTogglerToggleClass = function onMenuTogglerToggleClass(evt) {
  var target = evt.currentTarget;
  var targetId = target.getAttribute('data-target-id');
  var targetClassToggle = target.getAttribute('data-target-class-toggle');
